...
export default class UndoCommand extends BaseCommand {
    ...
    async run(context: Context, args: CommandArgs) {
        ...
        const allRecentInvocations = this.arduino.replies.filter(r => r.context.userId === context.userId && r.context.channelId === context.channelId && !r.reply.deleted);
